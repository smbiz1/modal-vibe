...
# Claude Code Agent in Modal Sandbox

This example demonstrates how to run Claude Code in a Modal Sandbox to safely analyze GitHub repositories. The sandbox provides an isolated environment where the AI agent can execute code and examine files without security risks.
