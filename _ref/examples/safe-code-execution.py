...
# Safe Code Execution in Modal Sandboxes

This example demonstrates how to run arbitrary code in multiple languages within a Modal Sandbox for safe, isolated execution.

## Multi-Language Environment Setup

Sandboxes allow running any kind of code in a safe, isolated environment.
